...
part of 'country_query.req.gql.dart';
...
class _$GcountriesReq extends GcountriesReq {
  ...
  factory _$GcountriesReq([void Function(GcountriesReqBuilder)? updates]) =>
      (new GcountriesReqBuilder()..update(updates))._build();
  ...
  _$GcountriesReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GcountriesReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GcountriesReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GcountriesReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GcountriesReq')
          ..add('vars', vars)
...
class GcountriesReqBuilder
  ...
  @override
  GcountriesReq build() => _build();

  _$GcountriesReq _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GcountriesReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
